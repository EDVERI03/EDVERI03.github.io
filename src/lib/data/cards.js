export const cards = [{ "name": "Large Man", "icon": "Portrait2.png", "description": "This stone-cold fellow apparently worked as a geologist before hitting rock-bottom and ending up here. The two of you had a rocky start but he does appear somewhat trustworthy.", "column": 0, "row": 0, "color": 0},
...
{ "name": "Corpse", "icon": "Portrait4.png", "description": "It is not very talkative. Its skin is unnaturaly pale in complexion, except for the back of the head and lower back which appers as a marble pattern of green and blue bruises aswell as its face, pressed down into the floor at an unsettling angle, now discolored by lividity into a dramatic display of uncountable shades of reds and purples.", "column": 1, "row": 1, "color": 0},]
