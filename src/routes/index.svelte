<div class="bg-slate-200 w-3/4 m-auto flex flex-col items-center text-center min-h-[93%]">
    ...
    <div class="mx-10 rounded-lg bg-slate-400 flex flex-none place-content-center w-fit overflow-x-scroll scrollable" >
        <img alt="card1" src="" class="w-48 h-64 bg-white rounded-lg m-6 hue-rotate-90">
        <img alt="card2" src="" class="w-48 h-64 bg-white rounded-lg my-6">
        <img alt="card3" src="" class="w-48 h-64 bg-white rounded-lg m-6 -hue-rotate-90">
    </div>
